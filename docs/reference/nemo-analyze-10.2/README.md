...
| 확보 범위 | 2026-09-01: **505페이지 전체**를 읽고 추출. 2026-09-02: 사용자가 PDF를 다시 제공(p1–299 · p400–504, **p300–399 미포함**)해 유즈케이스를 원문 전사 |
| 입수 경로 | 사용자가 직접 제공 |
...
| `use-cases.md` | **Use Case 31개 상세 — 원문 전사판.** 장 순서대로 목적 · 전제 · 단계별 절차 · 대화상자 필드와 예시 값 · 원문 인용 · 그림 77장 · 우리와의 관계. 29개는 원문 페이지에서 직접 옮겼고(●), UC25·26 앞부분은 이번 제공분에 없던 p300–399라 2026-09-01 추출본(◐) |
