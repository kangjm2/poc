...
public final class KpiSeed {
    ...
    public static List<KpiDefinition> definitions() {
        ...
        out.add(kpi("RSRP", "RSRP (NR SpCell)", "dBm", "무선 품질", "5G NR",
                "HIGHER_IS_BETTER", 1,
        ...
        out.add(kpi("RSRQ", "RSRQ (NR SpCell)", "dB", "무선 품질", "5G NR",
                "HIGHER_IS_BETTER", 1,
        ...
        out.add(kpi("SINR", "SS-SINR", "dB", "무선 품질", "5G NR",
                "HIGHER_IS_BETTER", 1,
        ...
        out.add(kpi("MAC_DL_THROUGHPUT", "MAC downlink throughput", "Mbps", "처리량", "5G NR",
        ...
        out.add(kpi("MAC_UL_THROUGHPUT", "MAC uplink throughput", "Mbps", "처리량", "5G NR",
        ...
        out.add(kpi("DL_BLER", "MAC downlink BLER", "%", "링크 적응", "5G NR",
        ...
        out.add(kpi("CQI", "CQI", "", "링크 적응", "5G NR", "HIGHER_IS_BETTER", 0,
        ...
        out.add(kpi("PDSCH_MCS", "PDSCH MCS CW0", "", "링크 적응", "5G NR",
        ...
        out.add(kpi("PDSCH_RANK", "PDSCH rank", "", "링크 적응", "5G NR",
        ...
        out.add(kpi("TX_POWER", "TX power (NR)", "dBm", "전력", "5G NR",
